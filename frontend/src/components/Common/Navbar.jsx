...
const Navbar = () => {
    ...
    return (
        <header className={`fixed w-screen top-0 h-20 border-b-[0.1px] bg-[#09090b] text-white flex justify-between items-center px-20 `}>
            ...
            <div className='flex items-center gap-4'>
                ...
                <Link to={''}><p className='cursor-pointer font-semibold hover:underline hover:underline-offset-4'>My Learning</p></Link>
            ...
            {user ?
                <div className='flex items-center gap-4'>
                    ...
                    <div className='bg-white h-[40px] w-[40px] rounded-full'> <img className='rounded-full object-cover' src={userData.image} alt="" /></div>
                </div>
                :
                <div className='flex items-center gap-4'>
